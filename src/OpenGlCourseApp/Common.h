...
#define CHUNK2D_NEIGHBOR_ID 0
#define CHUNK2D_NEIGHBOR_POS 1
#define CHUNK2D_MAX_NEIGHBOR_COUNT 8
#define CHUNKHANDLER2D_ORIGIN_CHUNK_NEIGHBOR_ID 0
#define CHUNKHANDLER2D_ORIGIN_CHUNK_NEIGHBOR_INDEX 1
#define CHUNKHANDLER2D_BORDER_CHUNK_ID 0
#define CHUNKHANDLER2D_BORDER_CHUNK_INDEX 1
